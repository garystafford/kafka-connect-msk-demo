...
ALTER TYPE mpaa_rating OWNER TO masteruser;
...
ALTER DOMAIN year OWNER TO masteruser;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp with time zone) OWNER TO masteruser;
...
ALTER FUNCTION public.last_day(timestamp with time zone) OWNER TO masteruser;
...
ALTER TABLE customer_customer_id_seq OWNER TO masteruser;
...
ALTER TABLE customer OWNER TO masteruser;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO masteruser;
...
ALTER TABLE actor_actor_id_seq OWNER TO masteruser;
...
ALTER TABLE actor OWNER TO masteruser;
...
ALTER TABLE category_category_id_seq OWNER TO masteruser;
...
ALTER TABLE category OWNER TO masteruser;
...
ALTER TABLE film_film_id_seq OWNER TO masteruser;
...
ALTER TABLE film OWNER TO masteruser;
...
ALTER TABLE film_actor OWNER TO masteruser;
...
ALTER TABLE film_category OWNER TO masteruser;
...
ALTER TABLE actor_info OWNER TO masteruser;
...
ALTER TABLE address_address_id_seq OWNER TO masteruser;
...
ALTER TABLE address OWNER TO masteruser;
...
ALTER TABLE city_city_id_seq OWNER TO masteruser;
...
ALTER TABLE city OWNER TO masteruser;
...
ALTER TABLE country_country_id_seq OWNER TO masteruser;
...
ALTER TABLE country OWNER TO masteruser;
...
ALTER TABLE customer_list OWNER TO masteruser;
...
ALTER TABLE film_list OWNER TO masteruser;
...
ALTER TABLE inventory_inventory_id_seq OWNER TO masteruser;
...
ALTER TABLE inventory OWNER TO masteruser;
...
ALTER TABLE language_language_id_seq OWNER TO masteruser;
...
ALTER TABLE language OWNER TO masteruser;
...
ALTER TABLE nicer_but_slower_film_list OWNER TO masteruser;
...
ALTER TABLE payment_payment_id_seq OWNER TO masteruser;
...
ALTER TABLE payment OWNER TO masteruser;
...
ALTER TABLE payment_p2017_01 OWNER TO masteruser;
...
ALTER TABLE payment_p2017_02 OWNER TO masteruser;
...
ALTER TABLE payment_p2017_03 OWNER TO masteruser;
...
ALTER TABLE payment_p2017_04 OWNER TO masteruser;
...
ALTER TABLE payment_p2017_05 OWNER TO masteruser;
...
ALTER TABLE payment_p2017_06 OWNER TO masteruser;
...
ALTER TABLE rental_rental_id_seq OWNER TO masteruser;
...
ALTER TABLE rental OWNER TO masteruser;
...
ALTER TABLE sales_by_film_category OWNER TO masteruser;
...
ALTER TABLE staff_staff_id_seq OWNER TO masteruser;
...
ALTER TABLE staff OWNER TO masteruser;
...
ALTER TABLE store_store_id_seq OWNER TO masteruser;
...
ALTER TABLE store OWNER TO masteruser;
...
ALTER TABLE sales_by_store OWNER TO masteruser;
...
ALTER TABLE staff_list OWNER TO masteruser;
